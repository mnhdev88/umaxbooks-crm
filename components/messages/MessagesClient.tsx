...
import { Send, Plus, ArrowLeft, Search, MessageSquare, X } from 'lucide-react'
...
export function MessagesClient({ userId, contacts, initialConversations }: Props) {
  ...
  async function send() {
    ...
    setConversations((prev) => {
      ...
      return [{ ...existing, last_message: msg.body, last_message_at: msg.created_at, unread: false },
                  ...
                  return (
                    <div key={m.id} className={cn('flex', mine ? 'justify-end' : 'justify-start')}>
                      <div className={cn(
                        ...
                        <p className={cn('text-[10px] mt-1', mine ? 'text-orange-100/70' : 'text-slate-500')}>
